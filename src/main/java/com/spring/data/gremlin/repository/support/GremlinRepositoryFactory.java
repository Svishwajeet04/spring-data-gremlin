 ...
 * license information.
 */
package com.spring.data.gremlin.repository.support;

import com.spring.data.gremlin.query.GremlinOperations;
import com.spring.data.gremlin.query.query.GremlinQueryMethod;
import com.spring.data.gremlin.query.query.PartTreeGremlinQuery;
import com.spring.data.gremlin.query.query.StringBasedGremlinQuery;
    ...
    private static class GremlinQueryLookupStrategy implements QueryLookupStrategy {
        ...
        public RepositoryQuery resolveQuery(@NonNull Method method, RepositoryMetadata metadata,
            ...
            if (queryMethod.hasAnnotatedQuery()) {
                return new StringBasedGremlinQuery(queryMethod, this.operations,
                        queryMethod.getAnnotatedQuery().get());
            }
