 ...
 * license information.
 */
package com.spring.data.gremlin.repository.config;

import com.spring.data.gremlin.repository.support.GremlinRepositoryFactoryBean;
...
import static com.spring.data.gremlin.common.Constants.DEFAULT_REPOSITORY_IMPLEMENT_POSTFIX;
