 ...
 * license information.
 */
package com.spring.data.gremlin.config;
...
public class GremlinConfigurationSupportUnitTest {
    ...
    private static final String TEST_CONFIG_PACKAGE_NAME = "com.spring.data.gremlin.config";
    private static final String TEST_DOMAIN_PACKAGE_NAME = "com.spring.data.gremlin.common.domain";
